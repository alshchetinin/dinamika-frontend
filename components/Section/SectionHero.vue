...
onMounted(() => {
  const splitTitle = new SplitType(element.value, {
    types: 'lines, words',
  })
  const splitTitleWords = splitTitle.words
  gsap.fromTo(
    splitTitleWords,
    {
      opacity: 0,
